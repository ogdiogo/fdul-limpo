    ...
    <section className="bg-[#f8f9fa] py-16 px-6 md:px-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className={sectionStyle}>
          ...
          <p className={textStyle}>
            O sigilo bancário também encontra regulamentação no Direito Civil, onde é considerado uma forma de proteção da privacidade e da confiança entre o cliente e a instituição financeira. No entanto, o Código Civil (artigo 340º) prevê uma exceção fundamental: a autorização do ofendido.
          </p>
          ...
          <p className={textStyle}>
            Se o titular da informação consentir na quebra do sigilo, a divulgação da informação torna-se lícita. Sem esse consentimento, a quebra de sigilo bancário configura um ilícito civil, podendo resultar em responsabilidade civil.
          </p>

          <div className="border-t border-gray-200 my-6"></div>

          <p className={`${textStyle} mt-4`}>
            O Código de Processo Civil contempla situações em que a quebra de sigilo bancário é necessária para garantir a busca da verdade material no âmbito de litígios civis. Nos processos executivos e providências cautelares, por exemplo, as instituições bancárias podem ser obrigadas a fornecer informações sobre os saldos bancários ou operações financeiras de uma pessoa ou empresa para assegurar que a justiça seja feita.
          </p>
        </div>
        ...
        <div className={sectionStyle}>
          ...
          <p className={textStyle}>
            A Constituição da República Portuguesa (artigos 101º a 107º) estabelece que a administração fiscal tem como objetivo primordial garantir a prosperidade económica e a justiça social, sendo a boa tributação um princípio fundamental.
          </p>

          <div className="border-t border-gray-200 my-6"></div>

          <p className={`${textStyle} mt-4`}>
            A derrogação do sigilo bancário em nome da Administração Fiscal é, portanto, uma medida legítima para assegurar que o sistema tributário funcione de maneira eficiente. Contudo, essa flexibilização do sigilo bancário para fins fiscais levanta questões sobre o equilíbrio entre a privacidade econômica e a necessidade de justiça tributária.
          </p>
          <p className={`${textStyle} mt-4`}>
            A informação bancária deve ser tratada com o maior cuidado, para que se evite a violação de direitos fundamentais. A administração fiscal tem a obrigação legal de tratar essas informações de forma confidencial e de utilizá-las apenas para os fins a que se destinam, sem extrapolar o seu uso ou comprometê-lo de forma indevida.
          </p>
        </div>
