      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className={`${sectionStyle} border-[#d4af37]`}>
          ...
          <p className={`${textStyle} mt-4`}>
            ...
            <br />
            1. <strong>Consentimento do titular da informação</strong>: Se o cliente autorizar expressamente a divulgação das informações, a quebra do sigilo torna-se legítima. Isso demonstra o caráter disponível do sigilo, ou seja, o cliente tem o direito de decidir sobre a divulgação das suas informações financeiras.
            <br />
            2. <strong>Ordem judicial</strong>: A quebra do sigilo também pode ocorrer mediante decisão de um juiz, que, após ponderar o valor do sigilo bancário e o interesse público ou o interesse da justiça, decide pela sua violação para garantir o bom andamento do processo penal. Este procedimento exige que a ordem seja emitida por uma autoridade judicial superior, o que visa conferir uma análise imparcial e justa da situação.
          </p>
          <p className={`${textStyle} mt-4`}>
