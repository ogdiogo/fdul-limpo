...
<div className="bg-white rounded-xl shadow-md p-8 mb-10">
  ...
  <section className="text-[#081b33]/90 text-justify">
    <p>
  ...
  {/* Caso do Tribunal da Relação de Évora */}
  <section className="text-[#081b33]/90 mt-4 text-justify">
    <p>
  ...
  {/* Branqueamento de Capitais e Sigilo Bancário */}
  <section className="text-[#081b33]/90 mt-4 text-justify">
    <p>
  ...
  <section className="text-[#081b33]/90 mt-4 text-justify">
    <p>
      Por isso, se por um lado a fiscalização tributária tem uma função preventiva e pedagógica, na medida em que contribui para dissuadir comportamentos ilícitos e para reforçar a percepção da inevitabilidade do cumprimento fiscal, sendo fundamental para a consolidação de uma cultura fiscal, sobretudo num contexto em que a complexidade das relações econômicas e a mobilidade dos capitais favorecem estratégias sofisticadas de planeamento fiscal agressivo e de ocultação de rendimentos, por outro, deve ser exercida com equilíbrio e discernimento.
    </p>
  </section>
</div>
