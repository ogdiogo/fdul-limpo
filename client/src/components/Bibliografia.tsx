    ...
    <section className="bg-[#f8f9fa] py-16 px-6 md:px-12">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="text-4xl font-bold text-[#081b33] text-center mb-12 flex items-center justify-center gap-3">
          <BookOpenText size={24} className="text-[#081b33]" />
          Bibliografia
        </h2>
        ...
        <div className="bg-white rounded-xl shadow-md p-8 border-l-4 border-[#6366f1]">
          <ul className="list-disc pl-6 space-y-6 text-[#081b33]/90 text-justify leading-relaxed">
            ...
            <li>
              Commission de Surveillance du Secteur Financier. (1993). <i>Loi du 5 avril 1993 relative au secteur financier (consolidated version).</i> Disponível em: <a href="https://www.cssf.lu/wp-content/uploads/L_050493_lfs.pdf" target="_blank" className="text-blue-600 underline">cssf.lu</a>
            </li>
            <li>
              Cordeiro, A. M. (2014). <i>Direito Bancário.</i> Coimbra: Almedina.
            </li>
            <li>
              KPMG Switzerland. (n.d.). <i>Federal Act on Banks and Savings Banks (Banking Act, BA).</i> Disponível em: <a href="https://assets.kpmg.com/content/dam/kpmgsites/ch/pdf/ch-banking-act-en.pdf" target="_blank" className="text-blue-600 underline">kpmg.com</a>
            </li>
            <li>
            ...
            <li>
              TOURNIER v. NATIONAL PROVINCIAL AND UNION BANK OF ENGLAND (IN THE COURT OF APPEAL, 1923).
            </li>
            <li>
